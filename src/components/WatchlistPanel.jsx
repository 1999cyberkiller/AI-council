    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true" onClick={onToggle}>
      <div ref={containerRef} className="modal-container" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
            <div className="modal-title">自选股</div>
                ...
                <div key={w.code} className="watchlist-item-wrap">
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: 6 }}>
                      <button onClick={() => onAnalyze(w)} className="list-btn list-btn--primary">召集议会</button>
                      <button onClick={() => onRemove(w.code)} className="list-btn list-btn--quiet" aria-label="移除">×</button>
                    </div>
                  </div>
                </div>
              ))}
